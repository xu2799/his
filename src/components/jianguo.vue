  ...
  <div id="wrap" :style="{ height: screenHeight + 'px' }">
    <div id="main" :style="{ top: nowTop + 'px' }">
      <ul id="pageUl" type="circle">
        ...
        <li id="pageUlLi6" class="pageUlLi" :class="{ active: curIndex == 6 }">
          &nbsp;
        </li>
      </ul>
...
<script>
import Guo from "./guo/guo.vue";
import Wuzhuang from "./guo/wuzhuang.vue"
import Changzheng from "./guo/zhangzheng"
import Chengli from "./guo/chengli.vue"
import Jiefang from "./guo/jiefang.vue"
import Kanzhan from "./guo/kanzhan.vue"
...
export default {
  ...
  data() {
    return {
      ...
      screenHeight: document.documentElement.clientHeight - 60, // 屏幕高度
      index: 1, // 用于判断翻页
